...
const { data } = await useAsyncData('home', () => queryContent('/posts').sort({ _id: -1 }).find())
...
useHead({
  ...
  titleTemplate: "Boloko's Blog - %s",
})
</script>
<template>
  <main class="container max-w-5xl mx-auto text-zinc-600">
    <MainHero title="Últimas postagens" subtitle="todos os assuntos"/>
